package com.bigwhite.webRtcClient;
...
public class WebRtcClient {
    ...
    private final static int MAX_PEER = 2;//最大连接数
   ...
   //添加ICE(交互式连接建立)候选
    ...
    private class MessageHandler {
        ...
        private Emitter.Listener onId = new Emitter.Listener() {
            @Override
            public void call(Object... args) {
                //接受服务端发过来的callid信息 执行oncallReady
                String id = (String) args[0];
                Log.e(TAG,"receive create roomid :" + id);
    ...
    public WebRtcClient(RtcListener listener, String host, PeerConnectionParameters params) {
        ...
        client.on("created", messageHandler.onId);//监听id消息，将其转发给handler处理，执行call函数.
        client.on("joined",messageHandler.onId);
